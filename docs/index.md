...
I specialize in data processing, predictive modeling, and data visualization. My daily toolkit includes Python and SQL, along with libraries and tools such as Pandas, Scikit-Learn, PyCaret, Streamlit, Plotly, and MlFlow. I also work with databases (SQLite, Qdrant) and cloud solutions (AWS S3), as well as frameworks for model evaluation and data validation, including Evidently, Pandera, and Ydata-Profiling.
...
<div style="text-align: center;">
    <img src="Zdjecie_1.jpg" alt="Image" width="600">
</div>
